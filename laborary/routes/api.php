...
// --- 实验室配置管理 (管理员专用) ---
Route::middleware(['jwt.auth', 'admin.role'])->prefix('admin/lab')->group(function () {
...
// --- 部门管理 (管理员专用) ---
Route::middleware(['jwt.auth', 'admin.role'])->prefix('admin/departments')->group(function () {
...
// --- 新闻公告管理 (管理员专用) ---
Route::middleware(['jwt.auth', 'admin.role'])->prefix('admin/lab-news')->group(function () {
